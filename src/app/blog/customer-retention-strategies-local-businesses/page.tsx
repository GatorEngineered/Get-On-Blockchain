    ...
    <main className={styles.articlePage}>
      <article className={styles.article}>
        ...
        <div className={styles.content}>
          ...
          <p>
            <strong>ROI Example:</strong> A <Link href="/industries/restaurants">restaurant</Link> with 200 monthly customers launches loyalty. 60 customers join, visit 40% more often. At $45/check, that's $1,080 extra monthly revenue for a $55/month program cost.
          </p>
