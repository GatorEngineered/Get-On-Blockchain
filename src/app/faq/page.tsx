...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "No setup fees, no hidden costs. You pay the monthly plan price ($99 for Basic, $149 for Premium). For Premium plan, you also fund your own payout wallet with USDC (like loading a gift card balance) - but that money goes directly to your customers as rewards, not to us.",
  },
  {
