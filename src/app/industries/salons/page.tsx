...
export const metadata: Metadata = {
  ...
  description:
    "Boost rebooking rates by 40% with our QR-based loyalty program for salons and spas. Reward visits, increase retention, proven ROI. Starting at $99/month.",
  keywords: [
        ...
        <div className={styles.roiInner}>
          ...
          <div className={styles.roiCard}>
            ...
            <div className={styles.roiCalculation}>
              ...
              <p className={styles.roiHighlight}>34x return on a $99/month Basic plan</p>
            </div>
